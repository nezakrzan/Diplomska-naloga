...
\begin{trditev}
$\mathbb{P}(A \mid B) = [\mathbb{P}(A) + \mathbb{P}(B)] - \mathbb{P}(A \wedge B)$, če sta $A$ in $B$ neodvisna.
\end{trditev}
...
\[\mathbb{P}(H \mid E) = \frac{\mathbb{P}(E \mid H)\mathbb{P}(H)}{\mathbb{P}(E)} = \frac{\mathbb{P}(E \mid H)\mathbb{P}(H)}{\mathbb{P}(E \mid H)\mathbb{P}(H) + \mathbb{P}(E \mid  \neg H)\mathbb{P}(\neg H)} .\]
...
\begin{enumerate}[label=(\roman*)]
    ...
    \item verjetnost dokazov $E$, ki je enaka $\mathbb{P}(E \mid H)\mathbb{P}(H) + \mathbb{P}(E \mid  \neg H)\mathbb{P}(\neg H)$;
    \item verjetnost $\mathbb{P}(E \mid H)$, tj. verjetnost dogodkov $E$ glede na hipotezo $H$.
\end{enumerate}

Obstaja še ena formulacija Bayesovega pravila, ki olajša izračune, še posebaj pri analizi dokazov z DNK:
\[\frac{\mathbb{P}(H \mid E)}{\mathbb{P}(\neg H \mid E)} = \frac{\mathbb{P}(E \mid H)}{\mathbb{P}(E \mid \neg H)} * \frac{\mathbb{P}(H)}{\mathbb{P}(\neg H)}.\]
Z drugimi besedami:
\[ \text{pogojna verjetnost} = \text{razmerje verjetnosti} * \text{predhodna verjetnost}.\]
Pogojna verjetnost $\mathbb{P}(H \mid E)$ je običajno podata z $\frac{PO}{1+PO}$, kjer je $PO$ pogojne verjetnosti.
