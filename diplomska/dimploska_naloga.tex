...
statistične analize poroti, sodniku in drugim v sodni dvorani.\\
%Med prebiranjem več poročil sodb, sem prišla do ugotovitve, da so ta vprašanja velikokrat pravilno postavljena oziroma postavljena v dobro strani, ki 
%jo odvetnik zagovarja, torej razlaga ponavadi ni primerna oziroma jasna. Torej se zmote lahko pojavijo že zaradi odvetnikov. 
...
matematične modele za vključevanje naših apriornih prepričanj in dokazov za ustvarjanje novih prepričanj oziroma za pridobitev aposteriornega 
...
pripisom predhodnih verjetnosti za hipoteze, ki nas zanimajo. Bayesov pristop bo deloval le, če bo izvedenec lahko začel s predhodno verjetnostjo.\\\\
...
strokovnjaki predlagajo, da bi analitiki morali predpostaviti enake predhodne verjetnosti za vse hipoteze v primeru, kar se včasih imenuje nevtralno 
...
verjetnost za vse hipoteze. To bi se lahko izkazalo za praktičen pristop, saj se lahko analitik s tem izogne vplivu lastnih in odvetnikovih predsodkov ter mnenj, 
ki bi lahko vplivali na predpostavke o verjetnostih. Na ta način se lahko zagotovi objektivnost analize, saj analitik ne bo 
poskušal prikazati ene hipoteze kot bolj verjetne od druge. Ko je predpostavljena enaka verjetnost za vse možnosti, se lahko nato uporabi 
Bayesovo pravilo za izračun posteriorne verjetnosti. Torej analitiki predpostavljajo, da sta predhodni verjetnosti $H_1$ in $H_2$ enaki, nato pa 
ju v skladu z Bayesovim pravilom pomnožijo z razmerjem verjetnosti, da določijo posteriorno verjetnost.  Kljub temu pa mislim, da moramo biti do tega 
pristopa nekoliko kritični, saj je predpostavljanje enake verjetnosti za vse možnosti problematično, kajti v realnosti se različne hipoteze 
razlikujejo po svoji verjetnosti.
...
upoštevati številnih zapletov, kot je vpliv stopnje laboratoratorijskih napak. Bayesovo pravilo pa namreč omogoča upoštevanje različnih dejavnikov in 
...
Na podlagi zgoraj omenjenih teorij, prebranih sodnih poročil in pravnih pravil, sem prišla do nekaterih ugotovitev glede vključevanja verjetnosti 
v sodne postopke.\\\\
Bayesovo pravilo torej vključuje razmerje verjetnosti in predhodno oziroma apariorno verjetnost, torej je celovitejši način predstavitve dokazov DNK.
Težavo ocenjevanja apriorne verjetnosti pri Bayesovem pravilu, bi lahko odpravili z osredotočanjem le na verjetnost. Ampak kakršnakoli privzeta 
predpostavka o predhodni verjetnosti je obravnavana kot kršitev obveznosti pravnega sistema, zato je drugi predlagani pristop, ki se mi zdi smiselen, 
da forenzični znanstveniki prevzamejo odgovornost za oceno predhodne verjetnosti ustreznih hipotez, preden jih posodobijo, v skladu z Bayesovim 
pravilom, na podlagi znanstvenih ugotovitev. Glavni očitek temu pristopu v okviru kazenskega postopka bi lahko bil, da lahko forenzični znanstveniki 
presežejo svoje znanstveno znanje in si prisvojijo vlogo tistega, ki ugotavlja dejstva. Da bi izvedenec določil predhodne smiselne verjetnosti, 
bi moral upoštevati vse dokaze v zadevi. Zato, na podlagi različnih virov, predlagam, da sodni izvedenci nimajo nobene vloge pri ocenjevanju 
predhodnih verjetnosti. \\\\
Vprašanje, ali naj forenzični znanstveniki upoštevajo predhodno verjetnost hipotez, ki naj bi jih pomagali ovrednotiti, je zapleteno. Odgovor je 
odvisen od vloge, ki jo bo forenzični znanstvenik imel v pravnem sistemu. Če bodo forenzični znanstveniki za pravne namene sprejemali ugotovitve 
v zvezi z določenim predlogom, ki jih zanima, potem bi morali in dejansko morajo upoštevati predhodne verjetnosti, da so hipoteze resnične. Če pa bo o
...
ampak samo vpliv statistike, znane kot razmerje verjetnosti(angl. Likelihood Ratio).
...
\begin{table}[h!]
    \centering
    \caption{Kvalitativna lestvica za poročanje o vrednosti $V$ podpore dokazov za $H_p$ proti $H_d$.}
    \label{table:1}
...
\subsection{Predstavitev primera}
