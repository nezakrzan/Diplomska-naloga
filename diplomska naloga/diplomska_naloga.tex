...
S binomsko porazdelitvijo lahko izračunamo verjetnost, da se bo dogodek $X$, na primer profil DNK, pojavil $k$ - krat v $s$ - kratnem
...
\]
torej je $f(x,y)$ odvisen le od $\frac{x}{y}$ in je zato $V$ funkcija razmerja verjetij
\[
...
$P(C \lvert \neg B)$, t.j. verjetnost, da se oseba, ki ni vpletena v kaznivo dejanje, ujema z dokazi kaznivega dejanja.\\\\
...
tj. $P(C \lvert \neg B)$, s $P(\neg A \lvert C)$, t.j. verjetnost, da obtoženec ni storil kaznivega dejanja, ampak se dokazi vseeno ujemajo 
